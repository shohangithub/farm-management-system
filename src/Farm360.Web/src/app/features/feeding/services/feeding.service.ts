...
export class FeedingService {
  ...
  getAnimalFeedingSummary(animalId: string): Observable<AnimalFeedingSummary> {
    return this.http.get<AnimalFeedingSummary>(`${this.baseUrl}/animals/${animalId}/summary`);
  }
